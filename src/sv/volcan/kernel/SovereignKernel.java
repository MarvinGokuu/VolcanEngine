...
public final class SovereignKernel {
     ...
     * 1. Detener el loop soberano (running = false)
    ...
    private void gracefulShutdown() {
        ...
        if (shutdownInProgress) {
            System.out.println("[SOVEREIGN KERNEL] Shutdown ya en progreso, ignorando...");
            return;
        }
        shutdownInProgress = true;

        System.out.println("═══════════════════════════════════════════════════════════════");
        System.out.println("[SOVEREIGN KERNEL] GRACEFUL SHUTDOWN SEQUENCE");
        System.out.println("═══════════════════════════════════════════════════════════════");

        // ═══════════════════════════════════════════════════════════════
        // PASO 1: DETENER LOOP SOBERANO
        // ═══════════════════════════════════════════════════════════════
        System.out.println("[STEP 1/6] Deteniendo loop soberano...");
        running = false;
        ...
        System.out.println("[STEP 1/6] Loop soberano detenido ✓");
        ...
        try {
            adminMetricsBus.sovereignShutdown();
        ...
        try {
            // StateVault usa Arena.ofConfined(), debe cerrarse explícitamente
            // (No hay método close() en VolcanStateVault, el Arena se cierra con GC)
            System.out.println("[STEP 5/6] State Vault marcado para GC ✓");
        } catch (Exception e) {
        ...
        System.out.println("═══════════════════════════════════════════════════════════════");
        System.out.println("[SOVEREIGN KERNEL] GRACEFUL SHUTDOWN COMPLETADO");
        System.out.println("═══════════════════════════════════════════════════════════════");
    }
}