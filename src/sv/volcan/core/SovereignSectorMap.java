 ...
 */
// ═══════════════════════════════════════════════════════════════════════════════
// CERTIFICACIÓN AAA+ - MEMORIA SOBERANA (SECTOR MAP)
// ═══════════════════════════════════════════════════════════════════════════════
//
// PORQUÉ:
...
public final class SovereignSectorMap<V> {
    ...
    public SovereignSectorMap() {
        this(DEFAULT_CAPACITY);
    }

    public SovereignSectorMap(int initialCapacity) {
