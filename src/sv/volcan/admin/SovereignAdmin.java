 ...
 * @since 2026-01-08
 */
public final class SovereignAdmin {
     ...
     * 
     * @param kernel Referencia al Kernel Soberano para telemetría
     */
    public static void igniteControlPlane(sv.volcan.kernel.SovereignKernel kernel) {
        try {
            // 1. Iniciar Gateway 8080 (Blind Server)
            System.out.println("[ADMIN] Igniting VolcanMetricsServer (Blind Gateway)...");
     ...
     * Separa la lógica "sucia" (String formatting) del Kernel Soberano.
     */
    private static void runAdminLoop(sv.volcan.kernel.SovereignKernel kernel) {
