 ...
 * DEPENDENCIAS: BaselineValidator, SovereignKernel, VolcanEngineMaster
...
public class Test_GracefulShutdown {
    ...
    public static void main(String[] args) {
        ...
        Thread engineThread = new Thread(() -> {
            try {
                ...
                SovereignKernel kernel = new SovereignKernel(dispatcher, vault);
